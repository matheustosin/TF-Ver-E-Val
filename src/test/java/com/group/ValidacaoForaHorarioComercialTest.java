...
public class ValidacaoForaHorarioComercialTest {
  ...
  private static Stream <Arguments> retornoExcecao() {
    return Stream.of(
      ...
      Arguments.of(new Produto(10, "Prod10", 1000.0), new ItemEstoque(10, 6), new ItemVenda(1, 10, 6, 1000.0))
    );
  }
}